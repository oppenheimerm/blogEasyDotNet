...
namespace BE.UseCases.Interfaces.DataStore
{
	public interface IPhotoFileRepository
	{
        ...
        /// <returns></returns>
        Task<(string FileName, bool Success, string ErrorMessage)> UploadCoverPhotoAsync(IFormFile cover, string path);
		/// <summary>
        ...
        /// <returns></returns>
        Task<(string FolderName, DateTime Timestamp, bool Success, string ErrorMessage)> CreatePostImageDirectoryAsync(string pathPrefix);
        ...
        /// <param name="path"></param>
        /// <returns></returns>
        Task<(string FileName, bool Success, string ErrorMessage)> UploadPhotoAsync(IFormFile image, string path);
		/// <summary>
